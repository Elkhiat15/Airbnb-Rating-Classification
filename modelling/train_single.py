...
from modelling.config import SINGLE_CONFIGS, TRAKING_URI, SINGLE_EXP_RUN
...
def train_single_params(
    ...
    mlflow.set_experiment(SINGLE_EXP_RUN)
    # Load data
...
if __name__ == "__main__":
    ...
    results = train_single_params(
        data_dir=args.data_dir, models_to_train=args.models, balance_method=args.balance
    )
