...
def train_all_models(
    data_dir: str = "data/processed/", models_to_train: list = None, cv_folds: int = 3
):
    ...
    mlflow.set_experiment(FULL_EXP_RUN)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Train classification models with MLflow tracking"
    )
    parser.add_argument(
        "--data-dir",
    ...
    train_all_models(
        data_dir=args.data_dir, models_to_train=args.models, cv_folds=args.cv_folds
    )
